...
export const metadata: Metadata = {
  ...
  keywords: ['SDVOSB', 'MBE', 'security contractor', 'DoD contractor', 'government security', 'protective security', 'law enforcement training', 'SecCon Group'],
  ...
  icons: { icon: '/seccon-mark-favicon.svg' },

        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-3 mt-2 flex-wrap">
              <span className="border border-accent-gold text-accent-gold text-xs font-heading font-medium px-2.5 py-1 rounded uppercase tracking-wider">
                SDVOSB
              </span>
              <span className="border border-accent-gold text-accent-gold text-xs font-heading font-medium px-2.5 py-1 rounded uppercase tracking-wider">
                MBE
          ...
          <div>
            ...
            <ul className="flex flex-col gap-1.5 text-text-secondary text-xs">
              <li>ITAR Compliant</li>
              <li>FAR / DFARS Compliant</li>
              <li>SAM.gov: Active — Pending</li>
              <li>CAGE: XXXXX</li>
              <li>UEI: XXXXXXXXXXXX</li>
            </ul>
          </div>
        </div>
